...
function cadastrarDespesa() {
    ...
    if (despesa.validarDados()) {
        ...
        msgModal.innerText = 'Dados gravados com sucesso!'
        ...
        msgModal.innerText = 'Existem campos obrigatórios sem preenchimento, por gentileza revisar!'
        $('#containerModal').modal('show')
        ano.value = ''
        mes.value = ''
        dia.value = ''
